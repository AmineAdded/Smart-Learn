...
// /**
//  * Obtenir la progression hebdomadaire
//  * CORRECTION : Utilise le totalXp de UserProgress au lieu de compter uniquement les QuizResult
//  */
...
//     // Récupérer le UserProgress pour avoir le totalXp réel
//     UserProgress progress = getOrCreateUserProgress(user);
...
//     // Calculer les XP de la semaine courante (depuis les QuizResult de cette semaine)
//     int currentWeekXp = currentWeekResults.stream()
//         .mapToInt(QuizResult::getXpEarned)
//         .sum();
    
//     // Calculer les XP de la semaine précédente
...
//     // Vérifier si la somme des XP quotidiens correspond
...
// }
// // Changer la visibilité de private à public
