...
class _QuizResultPageState extends State<QuizResultPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // ⭐ SOLUTION: Utiliser WillPopScope pour empêcher le retour avec le bouton back
    return WillPopScope(
      onWillPop: () async {
        // Rediriger vers la page d'accueil au lieu de revenir en arrière
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          // ⭐ Remplacer le bouton retour par un bouton qui va à l'accueil
          leading: IconButton(
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    onPressed: () {
                      ...
                      // Puis navigation vers les quiz
                      // Vous pouvez aussi naviguer directement vers QuizzesPage
                    },
                    icon: const Icon(Icons.refresh),
                    label: const Text('Voir d\'autres quiz'),
                    style: OutlinedButton.styleFrom(
                      foregroundColor: const Color(0xFF5B9FD8),
                      padding: const EdgeInsets.symmetric(vertical: 16),
                      side: const BorderSide(color: Color(0xFF5B9FD8)),
